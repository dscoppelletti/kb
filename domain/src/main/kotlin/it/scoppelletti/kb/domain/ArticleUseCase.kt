...
package it.scoppelletti.kb.domain
...
interface ArticleUseCase {
    ...
    fun create(model: ArticleModel): ArticleModel

    fun read(articleId: String): ArticleModel?

    fun update(model: ArticleModel): ArticleModel
